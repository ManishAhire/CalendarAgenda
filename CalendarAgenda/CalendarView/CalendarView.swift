...
class CalendarView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
    ...
    @IBInspectable var monthColor : UIColor = .black
    @IBInspectable var monthBackground : UIColor = .clear
    @IBInspectable var leftButton : UIImage = UIImage(named: "leftArrow")!
    @IBInspectable var rightButton : UIImage = UIImage(named: "rightArrow")!
    ...
    override func layoutSubviews() {
        ...
        monthView.backgroundColor = monthBackground
        monthView.lblName.textColor = monthColor
        monthView.btnLeft.setImage(leftButton, for: .normal)
        monthView.btnRight.setImage(rightButton, for: .normal)
    }
    func initializeView() {
...
//        monthView.lblName.textColor = monthViewLblColor
